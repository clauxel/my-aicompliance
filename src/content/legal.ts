...
export const legalPrivacySections: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'Cloudflare provides hosting, routing, security, DNS, analytics infrastructure, and edge execution. Polar provides hosted checkout and payment processing. Other providers may support telephony, speech, messaging, email, calendar, storage, and model workflows when production service is configured.',
...
export const legalTermsSections: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'Payments are processed by Polar in a hosted checkout window. Successful checkouts return the user to the homepage.',
  ...
  },
  {
    ...
    paragraphs: [
      'Cloudflare, Polar, Twilio, Deepgram, OpenAI, ElevenLabs, Supabase, Google Calendar, email providers, SMS providers, browser vendors, registrars, and other third parties may be involved in hosting, checkout, telephony, speech, messaging, storage, calendar, analytics, or model workflows.',
