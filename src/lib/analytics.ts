const visitorStorageKey = 'voiceaiagent-analytics-visitor'
const sessionStorageKey = 'voiceaiagent-analytics-session'
const queueStorageKey = 'voiceaiagent-analytics-queue'
